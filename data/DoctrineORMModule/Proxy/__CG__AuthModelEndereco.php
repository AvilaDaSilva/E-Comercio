 ...
 */
class Endereco extends \Auth\Model\Endereco implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'rua', 'cidade', 'bairro', 'cep', 'uf', 'numero', 'complemento');
        }
